                ...
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="permission:new">
                            <a href="/manage/permission/new" class="btn btn-success btn-sm">
                    ...
                    <table class="table tree">
                        ...
                        <c:forEach items="${permissionList}" var="permission">
                            <tr class="treegrid-${permission.id}
                                ...
                                </c:if><c:if test="${permission.pid == 0}">
                                    bg-gray
                                </c:if>">
                                ...
                                <td>
                                    <shiro:hasPermission name="permission:edit">
                                        <a class="btn btn-primary btn-xs editLink" rel="${permission.id}" href="javascript:;" title="编辑">
                                            <i class="fa fa-pencil"></i></a>
                                    </shiro:hasPermission>
                                    <shiro:hasPermission name="permission:del">
                                        <a class="btn btn-danger btn-xs delLink" rel="${permission.id}" href="javascript:;" title="删除">
