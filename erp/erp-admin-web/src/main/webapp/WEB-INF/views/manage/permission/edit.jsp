    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box">
                ...
                <div class="box-body">
                    <form method="post" action="/manage/permission/edit" id="editForm">
                        ...
                        <div class="form-group">
                            ...
                            <select name="pid" class="form-control">
                                ...
                                <c:forEach items="${menuPermissionList}" var="menuPermission">
                                    <option value=" ${menuPermission.id}" ${permission.pid == menuPermission.id ? 'selected' : ''}
                                    >${menuPermission.permissionName}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </form>
